...
const AboutMe = () => {
  return (
    <section id="aboutMe" className="max-container xl:grid xl:grid-cols-2 flex flex-col justify-center items-center w-full min-h-screen gap-x-10">
      ...
      >
        <h2 className="text-4xl font-robot text-white font-bold lg:max-w-lg mb-8">
          About Me
        </h2>
      ...
      <div className="flex flex-col justify-center items-center col-span-2 gap-8">
          ...
          viewport={{once: true}}
          variants={fadeIn('up', 'tween', 0, 1)}
          className="flex flex-wrap justify-start items-center gap-16"
          >
            {skillIcons.map((icon) => (
              <li key={icon.label}
                className="w-[64px]"
